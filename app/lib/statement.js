...
export default class Statement {
  ...
  start(fnStr='capitalize') {
    const startType = utils.confirmType(fnStr);

    switch (startType) {
      case 'string':
        this.startFn = () => { return fnStr; };
        break;
      case 'function':
        this.startFn = (wordList) => { return fnStr(wordList); };
        break;
      default:
        this.startFn = (wordList) => { return capitalize(wordList); };
        break;
    }
